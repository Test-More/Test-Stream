package Test::Sync::Formatter::TAP;
use strict;
use warnings;

use Test::Sync::Util qw/protect/;
...
my %CONVERTERS = (
    ...
    'Test::Sync::Event::Skip'      => \&_skip_event,
    'Test::Sync::Event::Note'      => \&_note_event,
    'Test::Sync::Event::Diag'      => \&_diag_event,
    'Test::Sync::Event::Bail'      => \&_bail_event,
    'Test::Sync::Event::Exception' => \&_exception_event,
    'Test::Sync::Event::Subtest'   => \&_subtest_event,
    'Test::Sync::Event::Plan'      => \&_plan_event,
);
...
sub event_tap {
    ...
    unless ($converter) {
        ...
        return if $legacy == \&Test::Sync::Event::to_tap;
...
sub _subtest_event {
    ...
    my $count = 0;
    my @subs = map {
        $count++ if $_->isa('Test::Sync::Event::Ok');
...
Test::Sync::Formatter::TAP - Standard TAP formatter
...
=head1 SYNOPSIS
    ...
    use Test::Sync::Formatter::TAP;
    my $tap = Test::Sync::Formatter::TAP->new();
...
=item Test::Sync::Formatter::TAP->register_event($pkg, sub { ... });
