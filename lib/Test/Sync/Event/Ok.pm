...
use Test::Sync::HashBase accessors => [
...
Test::Sync::Event::Ok - Ok event type
...
IO Handle identifiers are set to the value of the L<Test::Sync::Formatter::TAP> C<OUT_*>
constants.
