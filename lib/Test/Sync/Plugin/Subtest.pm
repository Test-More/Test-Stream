package Test::Sync::Plugin::Subtest;
use strict;
use warnings;
...
use Test::Sync::Plugin qw/import/;
...
Test::Sync::Plugin::Subtest - Tools for writing subtests

=head1 DESCRIPTION

This package exports subs that let you write subtests.

There are 2 types of subtests, buffered and streamed. Synced subtests mimick
...
L<Test::Builder> does it.
    ...
    use Test::Sync Subtest => ['streamed'];
    use Test::Sync::Plugin::Subtest qw/streamed/;
...
=head2 BUFFERED
    ...
    # You can use either of the next 2 lines, they are both equivilent
    use Test::Sync Subtest => ['buffered'];
    use Test::Sync::Plugin::Subtest qw/buffered/;
...
=head2 BOTH
    ...
    use Test::Sync::Plugin::Subtest qw/subtest_streamed subtest_buffered/;
