...
ok($plan->isa('Test::Sync::Event::Plan'), "got plan");
is($plan->max, 8, "planned for 8 oks");

ok($ok->isa('Test::Sync::Event::Ok'), "got 'ok' result");
is($ok->pass, 0, "'ok' test failed");

ok($is->isa('Test::Sync::Event::Ok'), "got 'is' result");
is($is->pass, 0, "'is' test failed");

ok($isnt->isa('Test::Sync::Event::Ok'), "got 'isnt' result");
is($isnt->pass, 0, "'isnt' test failed");

ok($like->isa('Test::Sync::Event::Ok'), "got 'like' result");
is($like->pass, 0, "'like' test failed");

ok($unlike->isa('Test::Sync::Event::Ok'), "got 'unlike' result");
is($unlike->pass, 0, "'unlike' test failed");

ok($is_deeply->isa('Test::Sync::Event::Ok'), "got 'is_deeply' result");
is($is_deeply->pass, 0, "'is_deeply' test failed");

ok($diag->isa('Test::Sync::Event::Diag'), "got 'diag' result");
is($diag->message, "Testing Diag", "got diag message");

ok($note->isa('Test::Sync::Event::Note'), "got 'note' result");
...
is(@$events, 1, "1 event");
ok($events->[0]->isa('Test::Sync::Event::Plan'), "got plan");
...
ok($events->[0]->isa('Test::Sync::Event::Bail'), "got the bail");
...
ok($events->[0]->isa('Test::Sync::Event::Ok'), "got ok");
...
is(@$events, 2, "2 events");
ok($events->[0]->isa('Test::Sync::Event::Ok'), "got ok");
ok($events->[1]->isa('Test::Sync::Event::Plan'), "finalize was called (only 1 plan)");
