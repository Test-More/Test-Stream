...
my $INST = Test::Sync::Global::Tracker->new;
...
Test::Sync::Global - Primary Synchronization point, this is where global stuff
lives.
...
L<Test::Sync::Global::Tracker> Object. All class methods defer to the single
...
=head1 SYNOPSIS
    ...
    use Test::Sync::Global; # No Exports

    my $init  = Test::Sync::Global->init_done;
    my $stack = Test::Sync::Global->stack;
    my $ipc   = Test::Sync::Global->ipc;

    Test::Sync::Global->set_formatter($FORMATTER)
    my $formatter = Test::Sync::Global->formatter;
...
=item Test::Sync::Global->set_formatter($class)
...
=item $bool = Test::Sync::Global->no_wait

=item Test::Sync::Global->no_wait($bool)
...
=item Test::Sync::Global->add_hook(sub { ... })
...
=item Test::Sync::Global->post_load(sub { ... })
...
=item $bool = Test::Sync::Global->loaded

=item Test::Sync::Global->loaded($true)
