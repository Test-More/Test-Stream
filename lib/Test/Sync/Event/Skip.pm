package Test::Sync::Event::Skip;
use strict;
use warnings;

use base 'Test::Sync::Event::Ok';
use Test::Sync::HashBase accessors => [qw/reason/];
...
Test::Sync::Event::Skip - Skip event type

=head1 DESCRIPTION

Skip events bump test counts just like L<Test::Sync::Event::Ok> events, but
they can never fail.
