package Test::Sync::Util;
use strict;
use warnings;

use Test::Sync::Capabilities qw/CAN_THREAD/;
use Scalar::Util qw/reftype blessed refaddr/;
use Carp qw/croak/;
use B();

use Test::Sync::Exporter qw/import export_to exports/;
exports qw{
        try protect
...
Test::Sync::Util - Tools used by Test::Stream and friends.

=head1 DESCRIPTION

Collection of tools used by L<Test::Sync> and friends.
...
use this conditionally with C<CAN_SET_SUB_NAME()>.
    ...
    use Test::Sync::Util qw/CAN_SET_SUB_NAME set_sub_name/;
