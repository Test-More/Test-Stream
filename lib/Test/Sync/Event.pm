...
sub import {
    ...
    Test::Sync::HashBase->import(into => $caller, base => $class, %args);
}
...
sub to_tap {
    ...
    require Test::Sync::Formatter::TAP;
    my $formatter = Test::Sync::Formatter::TAP->new;
...
Test::Sync::Event - Base class for events
...
=head1 SYNOPSIS
    ...
    package Test::Sync::Event::MyEvent;
    use strict;
    use warnings;
...
This callback is used by L<Test::Sync::Hub> to give your event a chance to
update the state.
...
This is used by L<Test::Sync::Event::Plan> to exit 0 when the plan is
'skip_all'. This is also used by L<Test::Sync::Event:Bail> to force the test
...
L<Test::Sync::Formatter::TAP> for TAP production.
...
constants provided by L<Test::Sync::Formatter::TAP>), C<$TEXT> should be the text that
...
Example:
    ...
    package Test::Sync::Event::MyEvent;
    use base 'Test::Sync::Event';
    use Test::Sync::Formatter::TAP qw/OUT_STD OUT_TODO OUT_ERR/;
