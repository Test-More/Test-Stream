package Test::Sync::Event::Subtest;
use strict;
use warnings;
...
use base 'Test::Sync::Event::Ok';
use Test::Sync::HashBase accessors => [qw/subevents buffered/];
...
Test::Sync::Event::Subtest - Event for subtest types

=head1 DESCRIPTION

This class represents a subtest. This class is a subclass of
L<Test::Sync::Event::Ok>.

=head1 ACCESSORS

This class inherits from L<Test::Sync::Event::Ok>.
