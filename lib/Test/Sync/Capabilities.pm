package Test::Sync::Capabilities;
use strict;
use warnings;
...
Test::Sync::Capabilities - Check if the current system has various
capabilities.
...
segfault whenever a new thread is launched. Test::Sync will attempt to detect
