...
sub new_hub {
    ...
    my $class = delete $params{class} || 'Test::Sync::Hub';
    ...
    if (@$self) {
        ...
        $hub->format(Test::Sync::Global->formatter->new)
...
Test::Sync::Stack - Object to manage a stack of L<Test::Sync::Hub>
instances.
...
This module is used to represent and manage a stack of L<Test::Sync::Hub>
...
=item $stack = Test::Sync::Stack->new()
